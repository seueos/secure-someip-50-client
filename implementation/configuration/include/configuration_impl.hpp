...
public:
    ...
    VSOMEIP_EXPORT std::string get_tls_min_version_for_endpoint(const std::string& _address, std::uint16_t _port) const;
    VSOMEIP_EXPORT std::string get_tls_max_version_for_endpoint(const std::string& _address, std::uint16_t _port) const;
    VSOMEIP_EXPORT std::string get_tls_ciphersuites13_for_endpoint(const std::string& _address, std::uint16_t _port) const;
    VSOMEIP_EXPORT std::string get_tls_ciphers_for_endpoint(const std::string& _address, std::uint16_t _port) const;
    VSOMEIP_EXPORT std::string get_tls_groups_for_endpoint(const std::string& _address, std::uint16_t _port) const;
    VSOMEIP_EXPORT std::string get_tls_sigalgs_for_endpoint(const std::string& _address, std::uint16_t _port) const;
    VSOMEIP_EXPORT std::string get_tls_early_data_for_endpoint(const std::string& _address, std::uint16_t _port) const;
    // Advanced TLS crypto parameters for experimentation
    VSOMEIP_EXPORT std::string get_tls_key_derivation_for_endpoint(const std::string& _address, std::uint16_t _port) const;
    VSOMEIP_EXPORT std::string get_tls_hash_for_endpoint(const std::string& _address, std::uint16_t _port) const;
    VSOMEIP_EXPORT std::string get_tls_message_auth_for_endpoint(const std::string& _address, std::uint16_t _port) const;
...
protected:
    ...
    // TLS extras indexed by (unicast, port): key->value
    std::map<std::string, std::map<std::uint16_t, std::map<std::string, std::string>>> tls_extra_;
};
